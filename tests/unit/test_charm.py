...
from charm import SERVICE_NAME, DdebRetrieverCharm
...
def test_pebble_ready(monkeypatch: pytest.MonkeyPatch):
    ...
    # Arrange:
    ctx = testing.Context(DdebRetrieverCharm)
    ...
    monkeypatch.setattr("charm.ddeb_retriever.get_version", mock_get_version)
